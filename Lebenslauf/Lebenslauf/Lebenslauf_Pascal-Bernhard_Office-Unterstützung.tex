\documentclass[11pt,a4paper,sans,titlepage]{moderncv}
...
\cvline{6/2009 - 9/2011}{\textbf{Werkstudent} \newline bei der
Unternehmensberatung SCI Verkehr GmbH in Berlin \newline
			\begin{itemize} 
			  \item Recherchearbeiten \& Mitarbeit an Marktstudien
				\& Wettbewerberanalysen
			  \item Korrespondenz \& telefonischer Kontakt mit Kunden
			  \item Arbeitszeitplanung für Projekte
			  \item Erstellung von Newslettern \&
...
\cvline{10/2008 - 4/2009}{\textbf{Praktikum} \newline am Forschungsinstitut
			...
			\begin{itemize}
			  \item Sekretariatsarbeiten:
				Korrespondenz, Dokumentenverwaltung,
				Materialbestellungen
			  \item Unterstützung des von der EU-Kommission in
				Auftrag gegebenen Forschungsprojektes
				\textsl{The Political Economy of EuroMed
				Governance}: Datenrecherche, Verfassen von
				Länderberichten, Vorbereitung von Vorträgen
				und Konferenzen
			\end{itemize} }
...
der American Chamber of Commerce in Paris \newline
			\begin{itemize}
			  ...
			  \item organisatorische Vorbereitung von
				Gesch\"aftsreisen
			  \item Verfassen von Pressemitteilungen und Newslettern
				\end{itemize} }
...
\cvline{ab 10/2013}{Diplomarbeit}
\cvline{Titel}{\emph{Energie-Versorgungssicherheit der Baltischen Staaten:
Chancen durch eine Europäische Energiepolitik}}
