\documentclass[11pt,sans,a4paper,titlepage]{moderncv}
...
Unternehmensberatung SCI Verkehr GmbH in Berlin \newline
			\begin{itemize} 
			  ...
			  \item Pflege interner Datenbank zu
				Eisenbahnverkehrsbetreibern
			  \item Korrespondenz \& telef. Kontakt mit Kunden
			\end{itemize} }

\cvline{11/2008 - 5/2009}{\textbf{Werkstudent} \newline bei Startup-Unternehmen
hiogi GmbH in Berlin (Anbieter von Dienstleistungen für mobile Geräte) \newline
			\begin{itemize}
			  \item Auswertung von Nutzer-Bewertungen
			  \item Informationsaustausch und Kontakt mit
				Nutzer-Community
...
\cvline{10/2008 - 4/2009}{\textbf{Praktikum} \newline am Forschungsinstitut
			...
			\begin{itemize}
			  ...
			  \item Unterstützung der Forschungsaktivitäten der
				hauptamtlichen Mitarbeiter: Erstellen von
				Präsentationen, Schaubildern sowie
				Excel-Tabellen 
			\end{itemize} }
